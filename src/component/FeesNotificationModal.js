...
export const FeesNotificationModal = ({plsOpen, feesData, handleClose }) => {
    ...
    useEffect(() => {
        setYesterDayCandidate(feesData.yesterdayCandidates);
        setTodayDayCandidate(feesData.todayCandidates);
        setAfterFourDayCandidate(feesData.afterFourDayCandidates);
    }, [])
