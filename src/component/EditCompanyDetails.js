	...
	const handleCompanyContactNumber = companyContactNumber => {
		if (companyContactNumber == "0") {
			...
			if (
				...
				validateContactNumber(companyContactNumber)
			) {
				axios
					.get(
						Urlconstant.url +
		...
		if (setIsConfirming) {
			...
			try {
				const updatedData = {
					...
					companyFounder:
						editedData.companyFounder === ""
							? rowData.companyFounder
							: editedData.companyFounder,
					companyWebsite:
						editedData.companyWebsite === ""
							? rowData.companyWebsite
							: editedData.companyWebsite,
					companyAddress:
						editedData.companyAddress === ""
				...
				<Grid container spacing={3}>
					...
					<Grid item xs={12} sm={4}>
						<TextField
							...
							name="companyWebsite"
							defaultValue={
								rowData.companyWebsite != "NA" ? rowData.companyWebsite : ""
							}
					...
					<Grid item xs={12} sm={4}>
						<TextField
							...
							name="companyFounder"
							defaultValue={
								rowData.companyFounder != "NA" ? rowData.companyFounder : ""
							}
					...
					<Grid item xs={12} sm={4}>
						<TextField
							...
							name="companyAddress"
							defaultValue={
								rowData.companyAddress != "NA" ? rowData.companyAddress : ""
							}
