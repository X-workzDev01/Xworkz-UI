...
const DownLoadToExcel = () => {
    ...
    const offeredAs = ['CSR Offered', 'Non-CSR Offered', 'General', 'College Referral', 'Triner Referral', 'Trinee Referral', 'HR Team Referral', 'Team Referral'];
    ...
    const TraineeDetails = (selectedInput) => {
        ...
        axios.get(Urlconstant.url + `api/csrdetails?offeredAs=${selectedInput}`).then((response) => {
