...
export default function DisplayData() {
  ...
  const editButtonRenderer = (props) => (
    <Button onClick={() => props.onEditClick(props.data)}>Edit</Button>
  );
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      field: "educationInfo.qualification",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Stream",
      field: "educationInfo.stream",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Year of Passout",
      field: "educationInfo.yearOfPassout",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "College Name",
      field: "educationInfo.collegeName",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Course",
      field: "courseInfo.course",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Branch",
      field: "courseInfo.branch",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Batch",
      field: "courseInfo.batch",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
    },
    {
      headerName: "Referral Name",
      field: "referralInfo.referalName",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
      hide: true,
    },
    {
      headerName: "Referral Contact Number",
      field: "referralInfo.referalContactNumber",
      cellStyle: { textAlign: "center" },
      filter: "agTextColumnFilter",
      hide: true,
    },
    ...
    getRows: (params) => {
      ...
      axios
        .get(
          Urlconstant.url +
            "api/" +
            `readData?startingIndex=${startRow}&maxRows=15`,
          {
            headers: {
  ...
  return (
    <div className="ag-theme-alpine" style={{ height: "100vh", width: "100%" }}>
      <Header />
      <h1>GridView</h1>
      <div className="ag-search-wrapper"></div>
